...
<body>
    ...
    <div class="container">
        ...
        <!-- CARD INFO (seperti di gambar) -->
        <div class="info-card mx-auto col-md-10 my-5">
            Kos nyaman dan bersih, lokasi strategis dekat kampus dan minimarket. <br>
            Fasilitas lengkap: tempat tidur, lemari, meja belajar, Wi-Fi, dan kamar mandi dalam. <br>
            Lingkungan aman dan tenang, cocok untuk pelajar atau pekerja.
        </div>
        ...
        <!-- MAP (jika ingin ditampilkan nanti)
        <iframe
